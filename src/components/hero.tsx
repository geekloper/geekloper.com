...
const Hero = forwardRef((_props, ref: Ref<HTMLDivElement>) => (
  <div ref={ref} className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-5 space-y-8">
    ...
    <div className="max-w-3xl text-left mx-auto">
      <TypeAnimation className="text-lg text-gray-700 dark:text-gray-400 " sequence={[400, 'Devops Engineer', 400, 'Cloud Engineer']} speed={70} wrapper="span" repeat={Infinity}></TypeAnimation>
    </div>
    <div className="max-w-3xl text-left mx-auto">
